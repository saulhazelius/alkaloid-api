...
def prediction(model_path, inpt, max_len):
    ...
    if len(inpt[0]) > max_len:
        ...
        logger.info("Number of 13C spectra greater than max spectra for alkaloids. Model not loaded for prediction.")
...
if __name__ == "__main__":
    ...
    logger.info(f"Alkaloid prediction: {True if predicted_value == 1 else False}")
